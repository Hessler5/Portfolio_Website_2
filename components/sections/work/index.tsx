...
const WORK = [
    {
        ...
        projects: [
            ...
            "Worked with sms messaging and added a consumer to scrub messages for keywords like “start” and “stop”",
            "Implemented a GraphQL api with Apollo Graphql",
            "Made a modular and customizable onboarding survey flow that could be configured via the cms",
