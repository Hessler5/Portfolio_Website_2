...
const PROJECTS: Array<Project> = [
    {
        ...
        description: "Pixel Harvester was my final project for the Flatiron School. This is a full stack website that allows users to scrape images from an inputted URL. The method of scrapping is not the traditional way of looping through an HTML tree or CSS selectors. Pixel Harvester uses image processing to take a screenshot of the webpage and then crop out sub images using that initial screen shot. To aid in the image processing I inject CSS rules into the page before Selenium takes the screenshot. Once the images are processed they are sent to the front end and deleted from the back end. The front end of Pixel Harvester allows you to sort through all of the returned images and select/rename the ones you want to download. When the user is ready they can simply hit download and they get a zip file with all of the images saved to their computer. This website also features full account creation, login, and authentication. Users are limited to 3 scrapes a day and a user that is not logged in can get one free trial scrape.",
    },
     {
        title: "Toy Tanks",
    ...
    },
     {
        ...
        description: "Battle Memes was the phase 4 full-stack group project for the Flatiron School. Our team set out to create a website that would act as a place where users could upload images in order to get them captioned by other users. The uploader could then pick their favorite caption and have it displayed on the website. All data fetched from the api is specific to the logged in user and all passwords are encrypted on the server. The back end api is built using Flask.",
    },
     {
